...
class PluginManager extends AbstractPluginManager
{
    ...
    public function install(array $meta, ContainerInterface $container)
    {
        ...
        $authorityRepository = $em->getRepository(\Eccube\Entity\Master\Authority::class);
        $authorityRoleRepository = $em->getRepository(\Eccube\Entity\AuthorityRole::class);
    ...
    {
        $em = $container->get('doctrine')->getManager();
        $csvRepository = $em->getRepository(\Eccube\Entity\Csv::class);
        $csvTypeRepository = $em->getRepository(\Eccube\Entity\Master\CsvType::class);
        ...
        // $cacheUtil = $container->getUtil(CacheUtil::class);
    ...
    public function uninstall(array $meta, ContainerInterface $container)
    {
        $em = $container->get('doctrine')->getManager();
        $authorityRepository = $em->getRepository(\Eccube\Entity\Master\Authority::class);
        $memberRepository = $em->getRepository(\Eccube\Entity\Member::class);
